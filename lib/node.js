...
(function() {
  ...
  Forwarder = (function() {
    function Forwarder() {
      ...
      this.sub.bindSync("tcp://*:*");
      this.pub.bindSync("tcp://*:*");
  ...
  ElectedNode = (function(_super) {
    ...
    function ElectedNode(options) {
      ...
      this.elector.on('ready', function(elector, addr) {
        return elector.start();
      });
      this.elector.on('error', function(err) {
        return _this.emit('error', err);
      });
      this.elector.on('elected', function(elect) {
    ...
    ElectedNode.prototype.connect_backend = function() {
      ...
      return this.sub_sock.on('message', function() {
        var msg;
        msg = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
